...
export default {
  ...
  data() {
    return {
      consultReportData: {
        diagnosis: "",
        needSurgicalAction: false,
        needMedicalDrug: false,
        cost: "",
      },
    };
  },
  methods: {
    ...mapActions(useAppointmentStore, ["createConsultReport", "fetchDiagnoses"]),
    createReport() {
...
<template>
  <section class="flex container mx-auto h-screen">
    <div class="flex w-[40%] max-h-[70%] border rounded-lg shadow-2xl bg-sky-200 bg-opacity-70 mx-auto mt-10">
      <div class="w-[80%] p-2 mt-4 text-sky-900 mx-auto">
        <div>
          <h1 class="text-3xl mb-3">Consultation Report</h1>
        </div>
        <div class="mb-3 text-slate-900">
          <p class="font-semibold">Diagnoses based on symptom ranked by accuracy</p>
          <ul>
          ...
          <form action="">
            <div class="mb-3">
              <label for="diagnosis">
                ...
                <input type="text" id="diagnosis" placeholder="Enter your diagnosis..."
            ...
            <div class="mb-3">
              <label for="needSurgicalAction">
                ...
                <select name="needSurgicalAction" id="needSurgicalAction"
            ...
            <div class="mb-3">
              <label for="needMedicalDrug">
                ...
                <select name="needMedicalDrug" id="needMedicalDrug" v-model="consultReportData.needMedicalDrug">
                  <option value="true">Yes</option>
                  <option value="false">No</option>
                </select>
              </label>
            ...
            <div class="mb-3">
              <label for="cost">
                ...
                <input type="text" id="cost" placeholder="Enter cost for appointment..."
                  v-model="consultReportData.cost"
                  class="md:p-1 border rounded w-full block text-sm text-sky-800 focus:outline-none focus:ring-2 focus:ring-sky-300 focus:border-sky-300 invalid:text-rose-500 invalid:focus:ring-rose-500 invalid:focus:border-rose-500" />
              </label>
            </div>
            <div class="mt-5">
              <button type="submit" @click.prevent="createReport"
