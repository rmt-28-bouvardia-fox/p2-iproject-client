...
<template>
  <section class="flex container mx-auto h-screen">
    <div
      class="flex w-[80%] max-h-[80%] border rounded-lg shadow-2xl bg-sky-300 bg-opacity-40 mx-auto mt-10"
    >
      <div class="p-2 w-full">
        ...
        <table
          class="w-full table-auto border-spacing-1 text-md text-center font-light text-sky-900"
        >
          <thead>
          ...
          <tbody>
            <TableItem
              v-for="(doctorAppointment, index) in doctorAppointments"
