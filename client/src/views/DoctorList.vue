...
<template>
  <section class="container h-full mx-auto">
    <div class="w-[60%] px-4 relative mx-auto">
      <div class="mx-auto">
        <div class="my-8">
          <h1 class="text-center text-4xl">Meet our <span class="text-sky-600">specialist</span></h1>
        </div>
      ...
      <div class="flex justify-center my-12">
        <!-- Previous Button -->
        <a href="#" @click.prevent="changePageDown"
          ...
          <i class="fi fi-rr-arrow-left mr-2 inline-flex justify-center items-center pt-0.5"></i>
          Previous
        </a>
        <a href="#" @click.prevent="changePageUp"
          ...
          Next
          <i class="fi fi-rr-arrow-right ml-2 inline-flex justify-center items-center pt-0.5"></i>
        </a>
      </div>
    </div>
